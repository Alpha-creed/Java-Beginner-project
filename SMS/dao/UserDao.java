...
public class UserDao {
    ...
    public void update(int id,String username,String email,String pass,String phone,String seq,String ans,String address1,String address2){
        String sql = "update user set uname=?,uemail=?, upassword = ?, uphone = ?,usecqus = ?,uans = ?,uaddress_1 = ?,uaddress_2 = ? where uid=?";
        try {
            ps=con.prepareStatement(sql);
    ...
    //get Users data
    public void getUsersValueData(JTable table,String search){
