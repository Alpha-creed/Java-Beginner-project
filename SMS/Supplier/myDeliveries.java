...
public class myDeliveries extends javax.swing.JFrame {
    ...
    private void init() {
        SupplierName = supplierDao.getSupplierName(SupplierDashboard.suppleirEmail.getText());
        myDeleiveredTable();
        setLocation(450, 180);

    }

    private void myDeleiveredTable() {
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        setVisible(false);
        SupplierDashboard.jPanel3.setBackground(primaryColor);
